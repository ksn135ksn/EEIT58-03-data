...
INSERT INTO `activity` (`id`, `host`, `description`, `location`, `activityTime`, `fee`, `min`, `max`, `reservation`, `contact`, `level`, `participataion`, `expired`, `postTime`) VALUES
